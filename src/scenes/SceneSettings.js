...
import { bgMusic, analytics } from "./SceneStart";
...
export default class SceneSettings extends Phaser.Scene {
  ...
  create() {
    ...
    const exitButton = this.add.rectangle(40, 40, 40, 40, 0x000000);
    ...
    const SoundButton = this.plugins
      .get("rexbuttonplugin")
      .add(this.SoundRect, {
        enable: true,
    ...
    const MusicButton = this.plugins
      .get("rexbuttonplugin")
      .add(this.MusicRect, {
        enable: true,
        mode: 0, // 0|'press'|1|'release'
